        ...
        for pair in pairs {
            match pair.as_rule() {
                ...
                Rule::address => {
                    ...
                    assert!(
                        address.eq("Петропавловсклівська"),
                        ...
                        match inner_pair.as_rule() {
                            Rule::planning_value => {
                                ...
                                assert_eq!(
                                    ...
                                    "The room planning does not match"
                                );
                            }
                            Rule::state_value => {
                                ...
                                assert_eq!(
                                    state, "Хороший стан",
                                    "The apartment state does not match"
                                );
                            }
                            _ => {}
                        }
                ...
                Rule::rieltor => {
                    for inner_pair in pair.into_inner() {
                        if inner_pair.as_rule() == Rule::rieltor_name {
                            ...
                            assert!(
                                rieltor_name.contains("Силова Ірина"),
                                "The rieltor name does not match"
                            );
                        }
                    }
                }
